...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    ourTeam: Attribute.Component<'our-team.our-team'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    whoWeAre: Attribute.Component<'who-we-are.who-we-are'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCustomerCustomer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    houseFlatNumber: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    role: Attribute.Enumeration<['Customer', 'Partner']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiNewNew extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Relation<
      'api::new.new',
      'manyToMany',
      'api::newsroom-category.newsroom-category'
    >;
    isBanner: Attribute.Boolean &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    smallImage: Attribute.Media<'images' | 'videos'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    largeImage: Attribute.Media<'images' | 'videos'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiNewsroomCategoryNewsroomCategory
  extends Schema.CollectionType {
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    productTypes: Attribute.Component<'product-types.product-types', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    generalParams: Attribute.Component<'general-params.general-params', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
